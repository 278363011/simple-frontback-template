...
public class MyGenerator {
    ...
    public static void main(final String[] args) {
        ...
        gc.setOutputDir("D:\\1234567890\\simple-frontback-template\\src\\main\\java\\");
...
//        });
        ...
        dsc.setUrl("jdbc:mysql://172.21.91.114:3306/psychologicalAppointment?allowMultiQueries=true&useUnicode=true&characterEncoding=UTF-8");
...
//        strategy.setInclude(new String[]{"sys_wxuser"}); // 需要生成的表
        ...
        focList.add(new FileOutConfig("/templates/mapper.xml.ftl") {
            ...
            public String outputFile(final TableInfo tableInfo) {
                return "D:\\1234567890\\simple-frontback-template\\src\\main\\resources\\mapper\\" + tableInfo.getEntityName() + "Mapper" + ".xml";
            }
        });
        cfg.setFileOutConfigList(focList);
        mpg.setCfg(cfg);
